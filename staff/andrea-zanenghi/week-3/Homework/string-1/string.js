...
function repeat(text,repeat){return text.repeat(repeat)}
console.log(repeat('Ha',4))

// Insert a word at a specific index

function insert(text,insert,position){
  textWithInsert = text.slice(0,position) + insert + text.slice(position)
  return textWithInsert
}
